...
def get_db_connection():
    return psycopg2.connect(
        ...
        user="postgres",
        password="postgres",
        host="127.0.0.1",   # localhost değil, IP yazıyoruz
        port="5432",
        client_encoding="utf8"  # işte bu satır kritik
    )
    #UnicodeDecodeError: 'utf-8' codec can't decode byte 0xd6 in position 55: invalid continuation byte
    # UnicodeDecodeError: 'utf-8' codec can't decode byte 0xd6 in position 61
...
def main():
    ...
    channel.basic_consume(queue="interpol_notices", on_message_callback=callback)
